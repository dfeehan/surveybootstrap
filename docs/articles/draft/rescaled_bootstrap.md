...
![](rescaled_bootstrap_files/figure-html/unnamed-chunk-1-1.png)![](rescaled_bootstrap_files/figure-html/unnamed-chunk-1-2.png)
...
You can write math expressions, e.g. *Y* = *X**β* + *ϵ*,
footnotes[¹](#fn1), and tables, e.g. using `knitr::kable()`.
